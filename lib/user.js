    ...
    ig.user_search(
      user_id, {
        ...
        if (err) {
          ...
          console.log('Found user ID:', log.success(users[0].id),
 ...
 *
 * A wrapper around Instagram's API: GET /users/user-id/media/recent
 ...
 *
 * Iteration can be done, for example, from a ES7 generator:
 *   suspend(function*() {
